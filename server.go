...
import (
	...
	"github.com/gryffyn/linx-server/backends/localfs"
	"github.com/gryffyn/linx-server/backends/s3"
	"github.com/gryffyn/linx-server/cleanup"
...
func setup() *web.Mux {
	...
	qrcodeRe := regexp.MustCompile("^" + Config.sitePath + `(?P<name>[a-z0-9-\.]+)/qr$`)
	...
	mux.Get(qrcodeRe, fileQRCodeHandler)
